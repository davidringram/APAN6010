...
#airline.kmeans$recommended <- factor(airline.kmeans$recommended) === No longer needed
#airline.kmeans$seat_types <- factor(airline.kmeans$type_of_travellers) === No longer needed
#airline.kmeans$type_of_travellers <- factor(airline.kmeans$type_of_travellers) === No longer needed
